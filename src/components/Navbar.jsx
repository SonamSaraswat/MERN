  ...
  return (
    ...
    <div className='w-full flex justify-between item-center font-semibold'>
        ...
        <div className='flex items-center gap-4'>
            <p className='bg-black text-white px-3 py-1 rounded-2xl text-[15px] cursor-pointer'>Log In</p>
    ...
    <div className='flex items-center gap-2 mt-4'>
        ...
        <p className='bg-black text-white px-4 py-1 rounded-2xl cursor-pointer'>Talks</p>
    </div>
    </>
  )
}
